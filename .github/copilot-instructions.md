# Copilot Instructions — `database-server`
...
- **Authoritative path**: `/home/ssf/Documents/Github/database-server` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/database-server.git`, branch `main`.
