# Copilot Compatibility Instructions - `database-server`
...
Repository: [https://github.com/speakASAP/database-server](https://github.com/speakASAP/database-server)
Authoritative checkout: `/home/ssf/Documents/Github/database-server` on `alfares`.
